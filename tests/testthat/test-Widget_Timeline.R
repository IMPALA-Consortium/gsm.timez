# Tests for Widget_Timeline function

test_that("Widget_Timeline returns a plotly object", {
  ...
  widget <- Widget_Timeline(dfFlagged)
...
test_that("Widget_Timeline wraps Visualize output", {
  dfSubjects <- data.frame(
    SubjectID = c(1, 2, 3, 4),
    SiteID = c("A", "A", "B", "B")
  )
